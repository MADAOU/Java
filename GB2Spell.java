public class GB2Spell {
    
    private static LinkedHashMap spellMap = new LinkedHashMap(400);

    public static void main(String[] args) {
        System.out.println(getFullSpell("?�D�Cnihao"));
        System.out.println(getFullSpell("?�D�C��?"));
    }
...
//
    ...
    public static String getSpellByAscii(int ascii){
        ...
        if (ascii < -20319 || ascii > -10247) { //�s�m���I����
            return null;
        }
        ...
        while (it.hasNext()) {
            ...
            if (valObj instanceof Integer) {
                ...
                if (ascii >= asciiRang0 && ascii < asciiRang) { //��?�Q��
